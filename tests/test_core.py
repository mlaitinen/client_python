...
class TestHistogram(unittest.TestCase):
    ...
    def test_histogram(self):
        self.assertEqual(0, self.registry.get_sample_value('h_bucket', {'le': '1'}))
        ...
        self.assertEqual(1, self.registry.get_sample_value('h_bucket', {'le': '5'}))
    ...
    def test_setting_buckets(self):
        ...
        self.assertEqual([0, 1, 2, float("inf")], h._upper_bounds)
    ...
    def test_labels(self):
        ...
        self.assertEqual(0, self.registry.get_sample_value('hl_bucket', {'le': '1', 'l': 'a'}))
        self.assertEqual(1, self.registry.get_sample_value('hl_bucket', {'le': '2.5', 'l': 'a'}))
        self.assertEqual(1, self.registry.get_sample_value('hl_bucket', {'le': '5', 'l': 'a'}))
